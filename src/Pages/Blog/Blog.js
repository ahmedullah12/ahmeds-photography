...
const Blog = () => {
    return (
        <div className='text-center'>
            <h1 className='mb-4 text-4xl font-semibold'>These are some important Questions and Answers</h1>
            <div>
                <div className='mb-4 p-5  border-2 rounded '>
                    <h3 className='mb-4 text-3xl'><span className='font-bold'>Q1: </span>What is the difference between SQL and NoSQL?</h3>
                ...
                <div className='mb-4 p-5  border-2 rounded '>
                    <h3 className='mb-4 text-3xl'><span className='font-bold'>Q2: </span>What is JWT, and how does it work?</h3>
                ...
                <div className='mb-4 p-5  border-2 rounded '>
                    <h3 className='mb-4 text-3xl'><span className='font-bold'>Q3: </span>What is the difference between javascript and NodeJS?</h3>
                ...
                <div className='mb-4 p-5  border-2 rounded '>
                    <h3 className='mb-4 text-3xl'><span className='font-bold'>Q4: </span>How does NodeJS handle multiple requests at the same time?</h3>
